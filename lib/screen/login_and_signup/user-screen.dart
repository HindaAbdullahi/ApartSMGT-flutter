...
import 'package:appart/api/api.dart';
import 'package:appart/models/user.dart';
...
class _UserScreenState extends State<UserScreen> {
  ...
  Future<List<User>> _getAllUsers() async {
    http.Response response = await http.get(Uri.parse(Api.url + '/users'));
